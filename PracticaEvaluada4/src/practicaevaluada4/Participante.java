...
public class Participante {
    ...
    public void mostrarParticipantes() {
        String mensaje = "";
        for (int i = 0; i < contador; i++) {
            mensaje += "El participante: " + maraton[i].getNombre() + " Con el numero " + maraton[i].getNumCorredor() + " En la categoria de " + maraton[i].getCategoria() + ""+" El tiempo estimao a completar es de "
